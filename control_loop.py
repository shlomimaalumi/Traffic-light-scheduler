...
from simple_scheduler import SimpleScheduler  # Importing Scheduler for type hinting


class ControlLoop:
    def __init__(self, intersection: Intersection, scheduler: SimpleScheduler):
    ...
    def run(self):
        ...
        while True:
            if SimpleScheduler.time_to_swap(self.intersection):
